...
public static class IProgressLoggerExtensions
{
    extension(IProgressLogger progressLogger)
    {
        ...
        {
            return progressLogger.AutoReportAsync((_, _) =>
                {
                    func();
        ...
        {
            return progressLogger.AutoReportAsync((progressLogger, _) =>
                {
                    func(progressLogger);
                    return ValueTask.CompletedTask;
                },
        ...
        {
            return progressLogger.AutoReportAsync((progressLogger, token) =>
                {
        ...
        {
            return progressLogger.AutoReportAsync(async ValueTask (_, _) => await func(), cancellationToken);
        }
        ...
        public Task AutoReportAsync(Func<CancellationToken, Task> func,
            CancellationToken cancellationToken = default)
        {
            return progressLogger.AutoReportAsync(async ValueTask (_, token) => await func(token),
                cancellationToken);
        }
        ...
        public Task AutoReportAsync(Func<IProgressLogger, CancellationToken, Task> func,
            CancellationToken cancellationToken = default)
        {
            return progressLogger.AutoReportAsync(async (progressLogger, token) =>
        ...
        {
            return progressLogger.AutoReportAsync(async (_, _) => await func(), cancellationToken);
        }
